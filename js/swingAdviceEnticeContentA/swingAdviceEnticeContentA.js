/*!
 * 福思维swingAdviceEnticeContentA面板
 * version: 1.0.0 
 * Need jQuery1.9.1
...
(function ($) {
    //实例化入口
    $.fn.swingAdviceEnticeContentA = function () {
        ...
        if (methods[method]) {
            ...
            $.error('jQuery.swingAdviceEnticeContentA中不存在方法' + method);
            return this;
        }
        ...
        init: function (options, data) {
            ...
            return this.each(function () {
                ...
                if (typeof (settings) == 'undefined') {
                    var defaultSettings = swingAdviceEnticeContentADefault;
                ...
                var simpleData = { "poData": { "性别": "男", "年龄": "29", "行业": "影视业" }, "aeData": [{ "延时时间": "2013-10-16", "导引级别": "E", "最近通话时间": "2013-10-06", "购买意向": "盗抢险+划痕险+自燃险" }, { "延时时间": "2013-10-16", "导引级别": "A", "最近通话时间": "2013-10-06", "购买意向": "交强险" }, { "延时时间": "2013-10-16", "导引级别": "B", "最近通话时间": "2013-10-06", "购买意向": "交强险" }] };
                var complexData = [{ "ID": "01", "name": "默认车系", "items": [{ "ID": "0101", "name": "默认车型", "swingAdviceEnticeContentA": { "poData": { "性别": "男", "年龄": "29", "行业": "影视业" }, "aeData": [{ "延时时间": "2013-10-16", "导引级别": "E", "最近通话时间": "2013-10-06", "购买意向": "盗抢险+划痕险+自燃险" }, { "延时时间": "2013-10-16", "导引级别": "A", "最近通话时间": "2013-10-06", "购买意向": "交强险" }, { "延时时间": "2013-10-16", "导引级别": "B", "最近通话时间": "2013-10-06", "购买意向": "交强险" }] } }] }];
                ...
                // 执行代码
                $this.empty();
                if (!$this.hasClass('swingAdviceEnticeContentA')) {
                    $this.addClass('swingAdviceEnticeContentA');
                }
                ...
                if (settings.LogConfig.level >= 3 && settings.LogConfig.isLogInfo) {
                    Diablo.printLog('界面元素', false, '实例化', '实例化swingAdviceEnticeContentA');
                }
    ...
    function _judgeHandler(Handlers, msg, mySettings) {
        ...
        for (var h in Handler) {
            ...
            if (isPremiseMeet) {
                _dealHandler.call(this, null, Handler[h], mySettings, msg);
            }
        }
    }
    ...
    function _getGroupDiv(parent, myBindData, mySettings) {
        ...
        for (var i in myBindData) {
            ...
            else if (myBindData[i].swingAdviceEnticeContentA) {
                if (myBindData[i].swingAdviceEnticeContentA.length > 0) {
                    $h3.click(function () {
                        $this = $(this);
                        if ($this.parent().hasClass('ui-collapsible-collapsed')) {
                            _explandNode(this);
                    ...
                    $content.append(_createContent(myBindData[i].swingAdviceEnticeContentA[0].swingRows, mySettings));
                }
            }
            else {
    ...
    function _createContent(zData, mySettings) {
        ...
        var $Content = $('<div class="swingPanelWrap"></div>');


        var $AEContent = $('<div class="AEContent" style="float:left;width:80%;height:100%;"></div>');
        var $AEContentA = $('<div class="AEContentA" style="float:left;width:100%;height:36%;"></div>');
        var $AEContentBar = $('<div class="AEContentBar" style="float:left;width:100%;height:10%;"><div style="float:left;"><a href="#">延迟</a></div><div style="float:left;"><a href="#">成功</a></div></div>');
        var $AEContentB = $('<div class="AEContentB" style="float:left;width:100%;height:54%;"></div>');
        $AEContentA.append(_createInputs(zData.poData,mySettings));
        $AEContentA.append(_createGrid(zData.aeData, mySettings));
        $AEContent.append($AEContentA).append($AEContentBar).append($AEContentB);
        $Content.append($AEContent);
        return $Content;
    }
