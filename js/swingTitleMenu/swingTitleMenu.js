...
(function ($) {
    ...
    $.fn.swingTitleMenu = function () {
        ...
        if (methods[method]) {
            ...
            $.error('jQuery.swingTitleMenu中不存在方法' + method);
            return this;
        }
        ...
        init: function (options, data) {
            ...
            return this.each(function () {
                ...
                if (typeof (settings) == 'undefined') {
                    var defaultSettings = swingTitleMenuDefault;
