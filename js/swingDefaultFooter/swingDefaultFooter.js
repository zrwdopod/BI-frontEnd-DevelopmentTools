...
(function ($) {
    //实例化入口
    $.fn.swingDefaultFooter = function () {
        ...
        if (methods[method]) {
            ...
            $.error('jQuery.swingDefaultFooter中不存在方法' + method);
            return this;
        }
        ...
        init: function (options, data) {
            ...
            return this.each(function () {
                ...
                if (typeof (settings) == 'undefined') {
                    var defaultSettings = swingDefaultFooterDefault;
                ...
                $this.addClass('swingDefaultFooter');
                ...
                //$this.append('<div>我是被实例化的swingDefaultFooter</div>');
                _bind.call(this);
            });
        },
        bind: function (data) {
